...
ORIG_SRCS = glfw.c monitor.c video_mode.c window.c
SRCS = $(ORIG_SRCS) 
OBJS = glfw.o monitor.o video_mode.o window.o
HDRS = $(srcdir)/common.h $(srcdir)/glfw.h $(srcdir)/glfw3.h $(srcdir)/glfw3native.h $(srcdir)/monitor.h $(srcdir)/video_mode.h $(srcdir)/window.h
LOCAL_HDRS = 
TARGET = glfw
TARGET_NAME = glfw
